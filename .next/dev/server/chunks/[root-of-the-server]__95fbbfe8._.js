...
async function GET() {
    try {
        ...
        const bookings = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Booking$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(filter).populate('service', 'name category price duration').populate('user', 'name email phone').sort({
            date: -1,
            startTime: -1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(bookings);
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dbConnect"])();
        const service = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(parsed.data.serviceId);
        ...
        // Calculate end time
        const startMin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schedule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseTimeToMinutes"])(parsed.data.startTime);
        const endTime = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$schedule$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["minutesToTime"])(startMin + effectiveDuration);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95fbbfe8._.js.map