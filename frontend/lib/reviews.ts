...
// Reviews sorted: those with photos come first for visual impact
export const reviews: Review[] = [
  // ─── WITH PHOTOS (first in carousel) ───
  {
    id: 1,
    name: "Sara C.",
    rating: 5,
    ...
    service: "Manicura combinada con refuerzo",
  ...
  },
  {
    ...
    service: "Pedicura completa con esmalte permanente",
